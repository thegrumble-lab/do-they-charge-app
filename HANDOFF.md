...
- **The full national dataset is loaded and kept in sync automatically**: restaurants, cafés and pubs from the FSA data (191,506 active listings as of the first real sync — see "Automated weekly sync" below), across all local authority areas. Verified via `select count(*)` in Supabase.
